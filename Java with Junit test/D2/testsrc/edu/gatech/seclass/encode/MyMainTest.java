...
*/
    ...
    // Failure Type: BUG #3: encode fails when passed an empty file
    @Test
    ...
    // Failure Type: BUG #2: encode fails when passed an empty string after remove option or forgot to specify what character want to remove
    @Test
    ...
    // Failure Type: BUG #8: encode fails when removing input contains duplicate characters
    @Test
    ...
    // Failure Type: BUG #7: encode fails when removing uppercase characters
    @Test
    public void encodeTest5() throws Exception {
        File inputFile1 = createInputFile1();

        String args[] = {"-d", "A",inputFile1.getPath()};
        Main.main(args);

        String expected5 = "bc $XYZ";
    ...
    // Failure Type: BUG #4: encode fails when encoding with increment 0, which means keeping whole file content unchanged
    @Test
    ...
    // Failure Type: BUG #8: encode fails when removing string has duplicate characters
    @Test
    ...
    // Purpose: <to test in case of not empty file and with whitespace and contains special characters>
    // Purpose: <test with remove option and reverse function together>
    // Frame #: 
    // New Failure Type: BUG #9: encode fails when implementing wrong option. It performs -R function instead.
    @Test
    public void encodeTest31() throws Exception {
        File inputFile1 = createInputFile1();

        String args[] = {"a", inputFile1.getPath()};
        Main.main(args);

        String expected31 = "abc $XYZ";

        String actual31 = getFileContent(inputFile1.getPath());

        assertEquals("The files differ!", expected31, actual31);
    }
    
    // Purpose: <to test in case of not empty file and with whitespace and contains special characters>
    // Purpose: <test with default function>
    // Frame #: 
    // New Failure Type: BUG #5: encode fails when implementing default function to a file, it should increment the length of file but it doesn't increment.
    @Test
    public void encodeTest32() throws Exception {
        ...
        String expected32 = "ijk $FGH";

        String actual32 = getFileContent(inputFile1.getPath());
    ...
    // Purpose: <to test in case of not empty file and with whitespace and contains special characters>
    // Purpose: <test with default function>
    // Frame #: <test case 42 in the catpart.txt.tsl of A6>
    // New Failure Type: BUG #10: encode fails when implementing cipher function but not specify how much need to increment
    @Test
    public void encodeTest33() throws Exception {
        File inputFile6 = createInputFile6();

        String args[] = {"-c", inputFile6.getPath()};
        Main.main(args);

        String expected33 = "abc #\n123 *XYZ!";

        String actual33 = getFileContent(inputFile6.getPath());
    ...
    // Purpose: <test with default function>
    // Frame #: 
    // New Failure Type: BUG #1: encode fails when implementing cipher function but increment input is empty
    @Test
    public void encodeTest34() throws Exception {
        ...
        String expected34 = "abc #\n123 *XYZ!";

        String actual34 = getFileContent(inputFile6.getPath());
    ...
    // Purpose: <test with default function>
    // Frame #: 
    // New Failure Type: BUG #5: encode fails when implementing cipher function with large increment number
    @Test
    public void encodeTest35() throws Exception {
        File inputFile6 = createInputFile6();

        String args[] = {"-c", "260", inputFile6.getPath()};
        Main.main(args);

        String expected35 = "abc #\n123 *XYZ!";

        String actual35 = getFileContent(inputFile6.getPath());

        assertEquals("The files differ!", expected35, actual35);
    } 
}
